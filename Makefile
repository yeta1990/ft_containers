...
INC = -I. -I../
SRCS = tests/tests.cpp tests/benchmark_vector.cpp tests/tests_set.cpp tests/tests_stack.cpp tests/tests_map.cpp tests/tests_more_iterators.cpp tests/tests_reverse_iterator.cpp
OBJS = $(SRCS:.cpp=.o)
RM = rm -f
